package com.example.daracademy.view.screens.formationScreen.component.descriptionItem
...
fun DescriptionItem(
    ...
    val animatedHeight by animateDpAsState(
        targetValue = if (show) 1500.dp else 100.dp,
        animationSpec = tween(
            durationMillis = 1000
        )
        ,
    ...
    Box(
        ...
        Text(
            text = description,
            style = NormalTextStyles.TextStyleSZ8.copy(fontFamily = josefinSansFamily , lineHeight = 20.sp),
